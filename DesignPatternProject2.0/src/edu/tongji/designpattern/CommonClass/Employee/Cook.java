...
public class Cook extends Employee {
    ...
    public void update() {
        if(order.getOrderState()==0)
            ...
            System.out.println("classname:"+this.getClass().getName()+"method: update action desc: 接受到新订单！厨师开始做菜");
        else

            System.out.println("classname:"+this.getClass().getName()+"method: update action desc: 订单完成！厨师等待服务员接菜");
